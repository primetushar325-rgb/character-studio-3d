...
class PaletteColors {
  ...
  /// Tiger / animal slots (fall back to human slots so recolors still work).
  Color get fur => _fur ?? skin;
  Color get furShade => _furShade ?? skinShade;
  Color get belly => _belly ?? const Color(0xFFFCE8C8);
  Color get stripe => _stripe ?? hair;
  Color get nose => _nose ?? const Color(0xFFB95B5B);
  Color get earInner => _earInner ?? const Color(0xFFEFA3A3);

  final Color? _fur;
  final Color? _furShade;
  final Color? _belly;
  final Color? _stripe;
  final Color? _nose;
  final Color? _earInner;

  PaletteResolver toResolver() => PaletteResolver({
        'skin': skin,
        'skinShade': skinShade,
        'hair': hair,
        'shirt': shirt,
  ...
  PaletteColors withOverrides(Map<String, Color> overrides) {
    ...
    return PaletteColors(
      ...
      book: c('book') ?? book,
      furC: c('fur') ?? _fur,
      furShadeC: c('furShade') ?? _furShade,
      bellyC: c('belly') ?? _belly,
      stripeC: c('stripe') ?? _stripe,
      noseC: c('nose') ?? _nose,
      earInnerC: c('earInner') ?? _earInner,
    );
  }
...
class Palettes {
  ...
  static const tigerDefault = PaletteColors(
    skin: Color(0xFFF09A2E),
    skinShade: Color(0xFFD97F1B),
    hair: Color(0xFF2E2620),
    shirt: Color(0xFFF09A2E),
    shirtPattern: Color(0xFF26201B),
    bottom: Color(0xFF26201B),
    accent: Color(0xFFEFA3A3),
    footwear: Color(0xFF2E2620),
    outline: Color(0xFF2B2523),
    furC: Color(0xFFF09A2E),
    furShadeC: Color(0xFFD97F1B),
    bellyC: Color(0xFFFCE8C8),
    stripeC: Color(0xFF2E2620),
    noseC: Color(0xFFB95B5B),
  ...
  static const stripeSwatches = [
    Color(0xFF2E2620), Color(0xFF1E1B18), Color(0xFF4A3B2E), Color(0xFF2E2E38),
  ];
